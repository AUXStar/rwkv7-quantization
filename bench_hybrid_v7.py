#!/usr/bin/env python3
"""Benchmark: Hybrid v7 — AWQ+NVFP4 FFN key + BF16 value + FP8 W8A16 att."""
import sys
...
HYBRID_MODEL = "/home/njzy/model/rwkv7-g1h-2.9b-hybrid-v7.pth"
...
print("=" * 80)
print("  Benchmark: Hybrid v7 (AWQ+NVFP4 W4A16 key + BF16 val + FP8 att)")
print("=" * 80)
...
print("\n  Generating logits...")
logits_446 = generate_logits(model, tokens_446, "v7_446")
logits_2100 = generate_logits(model, tokens_2100, "v7_2100")
torch.save(logits_446, f"{EVAL_DIR}/logits_hybrid_v7_446.pt")
torch.save(logits_2100, f"{EVAL_DIR}/logits_hybrid_v7_2100.pt")

r_446 = compare_logits(f"{EVAL_DIR}/logits_orig_446.pt", logits_446, f"{EVAL_DIR}/test_446.json", "Hybrid-v7 446")
r_2100 = compare_logits(f"{EVAL_DIR}/logits_orig_2100.pt", logits_2100, f"{EVAL_DIR}/test_2100.json", "Hybrid-v7 2100")
...
print(f"  {'v7 (AWQ+NVFP4 key+BF16 val+FP8 att)':<55} {r_2100['ppl_delta']:<12.4f} {r_2100['top1_agree']*100:<10.2f} {prefill_results[2100]['toks_per_s']:<10.0f} {decode_r['toks_per_s']:<10.0f}")
...
with open(f"{EVAL_DIR}/bench_hybrid_v7_results.json", "w") as f:
    json.dump(results, f, indent=2)
print(f"\n  Results saved to {EVAL_DIR}/bench_hybrid_v7_results.json")
