...
> **最新更新**: 2026-08-02 - 量化方案完整结论已整理
> **推荐方案**: 全FP8量化（见 [QUANTIZATION_CONCLUSION.md](QUANTIZATION_CONCLUSION.md)）

---

## 🎯 量化方案最终结论

**全FP8 是最优量化方案**，在所有指标上优于含 NVFP4 的方案：

| 模型 | 方案 | Top-1 | PPL delta | 速度 | VRAM | 压缩比 |
|------|------|-------|-----------|------|------|--------|
| 7.2B | 全FP8 | **93.75%** | +0.24% | **44.9 t/s** (6.4x) | **7.35 GB** | 55% |
| 7.2B | X5 (NVFP4+FP8) | 91.02% | +0.24% | 28.7 t/s (4.1x) | 8.54 GB | 61% |
| 1.5B | 全FP8 | **97.85%** | -0.08% | 67.8 t/s | **1.60 GB** | 60% |
| 1.5B | X5 (NVFP4+FP8) | 99.05% | +0.52% | 73.9 t/s | 1.53 GB | 57% |
...
|------|------|------|-------|---|---|---|--------|
| 2.9B | /path/to/rwkv7-2.9b.pth | 5.49 GB | bf16 | 2560 | 40 | 64 | 32 |
| 7.2B | /path/to/rwkv7-7.2b.pth | 13.41 GB | bf16 | 4096 | 64 | 64 | 32 |
